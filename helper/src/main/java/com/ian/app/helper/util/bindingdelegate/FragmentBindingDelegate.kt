package com.ian.app.helper.util.bindingdelegate
...
/**
 * Created by Ian Damping on 15,January,2021
...
class ViewBindingHolderImpl<T : ViewBinding> : ViewBindingHolder<T>, LifecycleObserver {
    ...
    override fun initBinding(binding: T, fragment: Fragment, onBound: (() -> Unit)): View {
...
interface ViewBindingHolder<T : ViewBinding> {
     ...
     */
    fun initBinding(binding: T, fragment: Fragment, onBound: (() -> Unit)): View
